...
# risk factors forest plot adjusting for co-attribution
...
# Save Figure 
ggsave(file="Figures/Figure 6 - Risk Factors - adjusting for co-attribution FINAL.pdf",q,width=10,height=12,dpi=300)
