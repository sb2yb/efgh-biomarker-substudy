...
df <- EFGH_substudy_rowperpid_ALLDATA %>%
  select(pid, country, clean_conc_log10_CAL, clean_conc_log10_HAEM, clean_conc_log10_MPO, clean_conc_log10_NGAL, shigella_attributable,
         ...
         rotavirus_attributable, sapovirus_attributable, ST.ETEC_attributable, tEPEC_attributable, dysentery)
...
# Save Figure 
ggsave(file="Figures/Figure S5 - Distribution of biomarkers by diarrhea etiology - Watery diarrhea - FINAL.pdf",plot,width=12,height=6,dpi=300)
