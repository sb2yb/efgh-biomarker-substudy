# density plots by dysentery variable: shigella NOT detected
...
########
  ...
  ggsave(file="Figures/Figure S4 - HAEM density - Shigella NOT detected - FINAL.pdf",blood_plot,width=10,height=6,dpi=300)
