# density plots by dysentery variable: shigella attributed
...
table(EFGH_substudy_rowperpid_ALLDATA$shigella_attributable, useNA= "always")
...
########
  ...
  blood_plot = blood_plot + xlim(-7, 4) # Set x-axis range to go from -2 to 3
  blood_plot

  ggsave(file="Figures/Figure S2 - HAEM density - Shigella attributed - FINAL.pdf",blood_plot,width=10,height=6,dpi=300)
